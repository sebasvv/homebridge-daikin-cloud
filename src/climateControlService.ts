...
export class ClimateControlService extends BaseService {
    ...
    constructor(
        ...
        this.helper = new ClimateControlHelper(this.platform, this.accessory.context.device, this.managementPointId, this.name);
        ...
        const roomTemperatureControlForCooling = this.helper.getData('temperatureControl', `/operationModes/${DaikinOperationModes.COOLING}/setpoints/${this.helper.getSetpoint(DaikinOperationModes.COOLING)}`);
        ...
        const roomTemperatureControlForHeating = this.helper.getData('temperatureControl', `/operationModes/${DaikinOperationModes.HEATING}/setpoints/${this.helper.getSetpoint(DaikinOperationModes.HEATING)}`);
    ...
    addOrUpdateCharacteristicRotationSpeed() {
        ...
        const fanControl = this.accessory.context.device.getData(this.managementPointId, 'fanControl', `/operationModes/${this.helper.getCurrentOperationMode()}/fanSpeed/modes/fixed`);
